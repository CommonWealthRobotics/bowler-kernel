...
/**
 * The connection methods Bowler supports.
 */
sealed class ConnectionMethod {
     ...
     */
    data class InternetAddress(val inetAddress: InetAddress) : ConnectionMethod()
     ...
     * @param name The name.
     */
    data class DeviceName(val name: String) : ConnectionMethod()
     ...
     */
    data class RawHID(val vid: Int, val pid: Int) : ConnectionMethod()
}
