...
interface UnprovisionedDigitalOutGroupFactory {

    /**
     * Makes an unprovisioned [DigitalOutGroup] attached to a device.
     *
     * @param device The device this [DigitalOutGroup] is attached to.
     * @param attachmentPoints The attachment points.
     * @return An unprovisioned [DigitalOutGroup] on success, a [RegisterError] on failure.
     */
    fun makeUnprovisionedDigitalOutGroup(
        device: BowlerDevice,
