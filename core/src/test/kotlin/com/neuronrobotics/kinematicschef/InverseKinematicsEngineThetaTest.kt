...
//        assert((cmmParams.computeDOffset(0.0).length() - 14.00).absoluteValue < 0.001)
//        assert((pumaParams.computeDOffset(0.0).length() - 14.90).absoluteValue < 0.001)
//        assert(hephaestusParams.computeDOffset(0.0).length() < 0.001)
//    }
//
//    @Test
//    fun `test compute cmm theta1`() {
//        (0..1000).forEach {
//            val wristCenter = cmmParams.forwardKinematics(
//                arrayOf(
//                    it * 0.01,
//                    0.0,
//                    0.0,
...
//        (0..1000).forEach {
//            val wristCenter = hephaestusParams.forwardKinematics(
//                arrayOf(
//                    it * 0.01,
//                    0.0,
//                    0.0,
...
//        (0..1000).forEach {
//            val wristCenter = pumaParams.forwardKinematics(
//                arrayOf(
//                    it * 0.01,
//                    0.0,
//                    0.0,
...
//        val wristCenter =
//            cmmParams.subList(0, 4).forwardKinematics(arrayOf(0.0, 0.0, 0.0, 0.0).toDoubleArray())
//                .cols(3, 4).rows(0, 3)
//        val theta1 = cmmParams.computeTheta1(wristCenter)[0]
//        val thetas23 = cmmParams.computeTheta23(wristCenter, theta1)
//
//        val newCenter = cmmParams.subList(0, 4)
//            .forwardKinematics(arrayOf(theta1, thetas23[0][0], thetas23[0][1], 0.0).toDoubleArray())
//
//        val newCenterVector = newCenter.cols(3, 4).rows(0, 3)
//
//        assert((wristCenter - newCenterVector).length() < 0.001)
//
//        val newWristCenter = cmmParams.subList(0, 4)
//            .forwardKinematics(arrayOf(0.0, 0.0, PI / 2, 0.0).toDoubleArray())
//            .cols(3, 4).rows(0, 3)
//        val newTheta1 = cmmParams.computeTheta1(newWristCenter)[0]
//        val newThetas23 = cmmParams.computeTheta23(newWristCenter, newTheta1)
//
//        val newNewCenter = cmmParams.subList(0, 4)
//            .forwardKinematics(
//                arrayOf(
//                    newTheta1,
//                    newThetas23[1][0],
...
//        val thetas23 = cmmParams.computeTheta23(wristCenter, theta1)
//        val thetas456 =
//            cmmParams.computeTheta456(target, wristCenter, theta1, thetas23[0][0], thetas23[0][1])
//
//        val tipElbowDown = cmmParams.forwardKinematics(
//            arrayOf(
//                theta1,
//                thetas23[0][0],
//                thetas23[0][1],
...
//        val target = cmmParams.forwardKinematics(
//            arrayOf(
//                0.0,
//                -PI / 4,
...
//            ).toDoubleArray()
//        )
//        val wristCenter = cmmParams.subList(0, 4)
//            .forwardKinematics(
//                arrayOf(
//                    0.0,
//                    -PI / 4,
...
//            cmmParams.computeTheta456(target, wristCenter, theta1, thetas23[0][0], thetas23[0][1])
//        val thetas456ElbowDown =
//            cmmParams.computeTheta456(target, wristCenter, theta1, thetas23[1][0], thetas23[1][1])
//
//        val wristElbowUp = cmmParams.subList(0, 4).forwardKinematics(
//            arrayOf(
//                theta1,
//                thetas23[0][0],
//                thetas23[0][1],
...
//        )
//
//        val wristElbowDown = cmmParams.subList(0, 4).forwardKinematics(
//            arrayOf(
//                theta1,
//                thetas23[1][0],
//                thetas23[1][1],
...
//        val wristCenter =
//            hephaestusParams.forwardKinematics(
//                arrayOf(
//                    0.0,
//                    -PI / 4,
//                    PI / 4 + 0.81979,
...
//
//        val newWristCenter =
//            hephaestusParams.forwardKinematics(arrayOf(PI, -PI / 2, PI / 2, 0.0).toDoubleArray())
//                .cols(3, 4).rows(0, 3)
...
//
//        val newNewCenter = hephaestusParams.forwardKinematics(
//            arrayOf(
//                newTheta1,
//                newThetas23[0][0],
//                newThetas23[0][1],
...
//        val wristCenter =
//            pumaParams.subList(0, 4).forwardKinematics(arrayOf(0.0, 0.0, 0.0, 0.0).toDoubleArray())
//                .cols(3, 4).rows(0, 3)
//        val thetas23 = pumaParams.computeTheta23(wristCenter, 0.0)
//
//        val newCenter = pumaParams.subList(0, 4)
//            .forwardKinematics(arrayOf(0.0, thetas23[1][0], thetas23[1][1], 0.0).toDoubleArray())
//
//        val newCenterVector = newCenter.cols(3, 4).rows(0, 3)
//
//        assert((wristCenter - newCenterVector).length() < 0.001)
//
//        val newWristCenter = pumaParams.subList(0, 4)
//            .forwardKinematics(arrayOf(0.0, 0.0, PI / 2, 0.0).toDoubleArray())
//            .cols(3, 4).rows(0, 3)
...
//
//        val newNewCenter = pumaParams.subList(0, 4)
//            .forwardKinematics(
//                arrayOf(
//                    newTheta1,
//                    newThetas23[0][0],
